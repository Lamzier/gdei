...
import Request.BusinessProcessing.loginAll;
...
public class Receive{
    ...
    public String Re_GET(){
        if (data.get("type") == null){return "欢迎来到我的世界！HelloWorld!";}
        String type = data.get("type")[0];
        String re = null;
        switch (type){
            case "searchNotice":
                re = Request.BusinessProcessing.lostGain.searchNotice(this);
                break;
            case "recruitmentNotice":
                re = Request.BusinessProcessing.lostGain.recruitmentNotice(this);
                break;
            default:
                re = Re_OTHER();
                break;
